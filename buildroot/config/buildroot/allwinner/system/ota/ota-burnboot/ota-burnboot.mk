...
OTA_BURNBOOT_SITE = $(PLATFORM_PATH)/../../../platform/allwinner/system/ota-burnboot
...
OTA_BURNBOOT_CFLAGS += -I$(STAGING_DIR)/usr/include -I$(@D) -I$(@D)/include -I$(STAGING_DIR)/usr/include
...
define OTA_BURNBOOT_INSTALL_STAGING_CMDS
	...
	cp -rf $(@D)/src/*.h $(STAGING_DIR)/usr/include
endef
