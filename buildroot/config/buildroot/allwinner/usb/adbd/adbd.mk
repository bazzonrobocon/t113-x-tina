...
ADBD_SITE = $(PLATFORM_PATH)/../../../platform/allwinner/usb/adbd/src
AUTH_SITE = $(PLATFORM_PATH)/../../../platform/allwinner/usb/adbd/auth
...
define ADBD_BUILD_CMDS
	...
	cp -rf $(PLATFORM_PATH)/allwinner/usb/adbd/scripts $(@D)/
endef

define ADBD_INSTALL_TARGET_CMDS
	$(INSTALL) -D -m 0755 $(@D)/adbd $(TARGET_DIR)/bin
	$(INSTALL) -D -m 0755 $(@D)/scripts/adb_shell $(TARGET_DIR)/bin
	$(INSTALL) -D -m 0755 $(@D)/scripts/adb_profile $(TARGET_DIR)/etc
endef
